public class Conversation {
    ...
    public static String getAnyFollow( int a, int b)
    {
	return followUp[a][b];
    }
	...
	if (Math.random() < 0.33)
	    {
		q = followUp[0][0]; qNum = 0;
	    }
	else if (Math.random() < 0.66)
	    {
		q = followUp[1][0]; qNum = 1;
	    }
	else {
	    q = followUp[2][0]; qNum = 2;
	}
	return " has some questions for you too.\n" + q;
    }
    public static String getfollowA(int a)
    {
	return followUp[qNum][a];
    }
