public class Story
{
    ...
    private static String[] interruption = {"accidentally stuck their tongue in a plug", "got hit with a pipe of exhaust", "was forced by the Mafia to make toast in the tub", "got nailed to a cross", "was deprived of breath until it was gone", "set fire to their hair", "poked a stick at a grizzly bear", "ate medicine that was out of date", "fell off of a cliff", "was hit by intense existential pain"};
    ...
    {
	return they + " was " + action[(int) (Math.random() * 10)] + " when, suddenly, " + they + interruption[(int) (Math.random() * 10)] + " but then, " + they + luck[(int) (Math.random() * 10)] + " and survived.";
    }
